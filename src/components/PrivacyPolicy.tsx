...
const sections = [
  {
    ...
    content: [
      ...
      },
      {
        type: "highlight",
        value:
          "If you have any questions or concerns about this policy, please contact us at info.websolsoffttech@gmail.com or via WhatsApp at +91 92337 70627.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: "text",
        value:
          "To exercise any of these rights, contact us at info.websolsoffttech@gmail.com. We will respond to all legitimate requests within 30 days.",
      },
    ],
  },
  {
              ...
              <div className="pp-contact-card">
                ...
                <div className="pp-contact-info">
                  <div className="pp-contact-row">
                    ...
                    <a href="mailto:info.websolsoffttech@gmail.com" className="pp-contact-link">info.websolsoffttech@gmail.com</a>
                  </div>
                  <div className="pp-contact-row">
                    <div className="pp-contact-icon-wrap">
